...
if __name__ == '__main__':
    ...
    config.set('ldap',   'ldap_server',  'SUPYSONIC_LDAP_SERVER')
    config.set('ldap',   'base_dn',      'SUPYSONIC_LDAP_BASE_DN')
    config.set('ldap',   'user_filter',  'SUPYSONIC_LDAP_USER_FILTER')
    config.set('ldap',   'admin_filter', 'SUPYSONIC_LDAP_ADMIN_FILTER')
    config.set('ldap',   'bind_dn',      'SUPYSONIC_LDAP_BIND_DN')
    config.set('ldap',   'bind_password','SUPYSONIC_LDAP_BIND_PASSWORD')
    config.set('ldap',   'username_attr','SUPYSONIC_LDAP_USERNAME_ATTR')
    config.set('ldap',   'email_attr',   'SUPYSONIC_LDAP_EMAIL_ATTR')
    config.stor()
